...
/**
 The timestamp generated by the origin homeserver when it receives the event from the client.
 */
...
/**
 ...
 It is computed by the user's home server each time it sends the event.
 */
