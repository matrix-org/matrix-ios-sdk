...
/**
 ...
 @param clientSecret a secret key generated by the client.
 @param sendAttempt the number of the attempt for the validation request. Keep the same
                    value to make the server resend an email with the same token.
                    Increase it to change the token sent.
