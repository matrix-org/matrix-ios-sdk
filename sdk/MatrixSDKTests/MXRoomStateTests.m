 ...
 */
- (void)createInviteByUserScenario:(MXRestClient*)bobRestClient inRoom:(NSString*)room_id onComplete:(void(^)())onComplete
{
...
- (void)testInviteByOtherInInitialSync
{
    ...
    [sharedData doMXRestClientTestWithBobAndARoom:self readyToTest:^(MXRestClient *bobRestClient, NSString *room_id, XCTestExpectation *expectation) {
        ...
        [self createInviteByUserScenario:bobRestClient inRoom:room_id onComplete:^{
