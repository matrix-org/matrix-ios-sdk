...
- (void)checkMXSessionOnStoreDataReady:(Class)mxStoreClass
{
    [matrixSDKTestsData doMXRestClientTestWithBobAndARoomWithMessages:self readyToTest:^(MXRestClient *bobRestClient, NSString *roomId, XCTestExpectation *expectation2) {
        ...
        [store openWithCredentials:matrixSDKTestsData.bobCredentials onComplete:^{
            ...
            XCTAssertNil(myUser);
            XCTAssertEqual(store.summariesModule.rooms.count, 0);
            ...
            [mxSession setStore:store success:^{
                ...
                [mxSession start:^{
                    ...
                    NSUInteger storeRoomsCount = store.summariesModule.rooms.count;
                    ...
                    [bobRestClient createRoom:nil visibility:kMXRoomDirectoryVisibilityPrivate roomAlias:nil topic:nil success:^(MXCreateRoomResponse *response) {
                        ...
                        [bobRestClient sendTextMessageToRoom:response.roomId text:@"A Message" success:^(NSString *eventId) {
                            ...
                            [mxSession2 setStore:store2 success:^{
                                ...
                                XCTAssertEqual(store2.summariesModule.rooms.count, storeRoomsCount, @"There must still the same number of stored rooms");
                                ...
                                [mxSession2 start:^{
                                    ...
                                    XCTAssertEqual(store2.summariesModule.rooms.count, storeRoomsCount + 1, @"There must still the same number of stored rooms");
        ...
        [mxSession setStore:store success:^{
            ...
            [mxSession start:^{
                ...
                [room leave:^{
                    ...
                    XCTAssertEqual(NSNotFound, [store.summariesModule.rooms indexOfObject:roomId], @"The room %@ must be no more in the store", roomId);
                    ...
                    [store2 openWithCredentials:matrixSDKTestsData.bobCredentials onComplete:^{
                        ...
                        XCTAssertEqual(NSNotFound, [store2.summariesModule.rooms indexOfObject:roomId], @"The room %@ must be no more in the store", roomId);
                ...
                [bobStore2 openWithCredentials:matrixSDKTestsData.bobCredentials onComplete:^{
                    ...
                    [aliceStore openWithCredentials:matrixSDKTestsData.aliceCredentials onComplete:^{
                        ...
                        [bobStore3 openWithCredentials:matrixSDKTestsData.bobCredentials onComplete:^{
                            ...
                            XCTAssertEqual(bobStore2.summariesModule.rooms.count, bobStore3.summariesModule.rooms.count);
                ...
                [mxSession setStore:store success:^{
                    [mxSession start:^{
                        ...
                        [store2 openWithCredentials:bobRestClient.credentials onComplete:^{
                            ...
                            MXRoomSummary *summary = [store2.summariesModule summaryOfRoom:response.roomId];
