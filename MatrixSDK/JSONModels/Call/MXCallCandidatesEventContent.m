...
+ (id)modelFromJSON:(NSDictionary *)JSONDictionary
{
    ...
    if (callCandidatesEventContent)
    {
        ...
        MXJSONModelSetNumber(callCandidatesEventContent.versionNumber, JSONDictionary[@"version"]);
        MXJSONModelSetString(callCandidatesEventContent.versionString, JSONDictionary[@"version"]);
