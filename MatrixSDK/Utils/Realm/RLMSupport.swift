...
protocol _RLMCollectionIterator {
    /**
...
/// :nodoc:
typealias RLMDictionarySingleEntry = (key: String, value: RLMObject)
...
// Disabled since `@_implementationOnly`-importing Realm prevents these extensions. Note that this makes this whole file basically useless.
 ...
 */
struct RLMCollectionIterator: IteratorProtocol {
 ...
 */
struct RLMDictionaryIterator: IteratorProtocol {
    private var iteratorBase: NSFastEnumerationIterator
    ...
    mutating func next() -> RLMDictionarySingleEntry? {
